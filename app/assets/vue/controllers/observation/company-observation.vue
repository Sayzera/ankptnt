...
<script>
import { ref } from 'vue'
import header from "./inc/componeyObservation/Header"
import ObservationList from "./inc/componeyObservation/ObservationList.vue";
...
export default {
  ...
  components: {
    ...
    // 'observation-list-component': ObservationList,
  }
      ...
      <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div class="project mb-4">
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" data-bs-toggle="tab" href="#AllStatus" role="tab"></a>
            </li>
            <li class="nav-item">
