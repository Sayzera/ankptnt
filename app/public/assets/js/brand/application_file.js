      ...
      columnDefs: [
        {
          ...
          render: function (data, type, row, meta) {
            console.log(row);
            return `
            <div style="text-align: left; width: 76px;"><img class="v-image v-widget" src="http://apiz.ankarapatent.com/fileServer/tmImage?res=64&amp;appNo=${row.application_number}" alt=""></div>           
            `;
          },
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, row, meta) {
            let url = `/company/observation/${
              row.class ? row.class.replaceAll(",", "-") : ""
            }/${row.trademark}/${row.id}`.replaceAll(" ", "");
