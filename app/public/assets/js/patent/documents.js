      ...
      .DataTable({
        ...
        columnDefs: [
...

          {
            ...
            render: function (data, type, row, meta) {
              return `
              <span onclick="ApplicationFile.getDetailInfo(${row.ref_file})" class="text-primary text-decoration-underline" data-bs-toggle="modal" data-bs-target=".detay-modal">${row.col_title}</span>
          ...
          },
          {
            ...
            render: function (data, type, row, meta) {
              return `
              <a href="#" onclick="alert('Henüz aktif değil!')" class="text-primary text-decoration-underline">İndir</a>
