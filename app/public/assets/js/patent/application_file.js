...
let ApplicationFile = {
                ...
                api
                    ...
                    .each(function (colIdx) {
                        ...
                        if(title == 'Başvuru Tarihi') {
                            ...
                            $(cell).html('<input type="text" class="verilis-tarihi"  placeholder="' + title + '" />');

                        } else if(title=="Taks. Tarihi") {
                            $(cell).html('<input type="text" class="taks-tarihi"  placeholder="' + title + '" />');
    ...
    initCustomColumnDate: () => {
        ...
        $('input[class="verilis-tarihi"]').on('apply.daterangepicker', function(ev, picker) {
            $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
        });
        ...
        $('input[class="taks-tarihi"]').on('apply.daterangepicker', function(ev, picker) {
            $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
        });
    },
    init: function () {
